...
//  : This component provides a card for users to start a WhatsApp chat about a project, including dynamic message generation and trust indicators.
const ProjectChatOnWhatsApp = ({ project }) => {
  const whatsappNumber = "919714512452";

  //  : Generate a dynamic WhatsApp message based on project details.
  ...
  //  : Open WhatsApp chat in a new browser tab with the generated message.
  ...
  return (
    //  : Main card container with background and hover effects for WhatsApp chat.
      ...
      <div className="relative p-8">
        ...
        <div className="flex items-start gap-4 mb-6">
          <div className="relative">
            ...
            {/*  : Online pulse indicator for agent availability. */}
            <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-green-400 rounded-full border-2 border-white animate-pulse"></div>
          </div>
          {/*  : Textual info about chat. */}
        ...
        {/*  : WhatsApp chat button with animation. */}
        <button
        ...
        >
          ...
          {/*  : Button content with WhatsApp and arrow icons. */}
        ...
        {/*  : Trust indicator section with icons and labels. */}
