...
//  : This component displays a list of amenities for a project, with a toggle to show all or a limited set.
const AmenitiesSection = ({ project, showAllAmenities, toggleAmenities }) => {
  return (
    //  : Main container for the amenities section with styling.
    <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
      {/*  : Section Heading for amenities. */}
      <h2 className="text-2xl font-semibold mb-8 text-gray-900">Amenities</h2>

      {/*  : Amenities Grid for displaying amenity items. */}
      ...
      {/*  : Toggle Button to show all or less amenities. */}
