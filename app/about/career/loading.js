...
/**
 *  : This file provides a loading skeleton for the Career page, mimicking the final layout while data loads.
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center">
      ...
      <div className="w-[80%] px-4 sm:px-6 md:px-8 lg:px-10 py-6 flex justify-center">
        <div className="w-full max-w-[1280px] grid gap-6 grid-cols-1 lg:grid-cols-3">
          {/*  : Render multiple skeleton cards to represent a loading list. */}
          {[...Array(6)].map((_, index) => (
