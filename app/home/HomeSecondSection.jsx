...
//  : This component displays the second section of the home page, featuring a heading, description, images, and a call-to-action button.
export default function HomeSecondSection({ data }) {
  ...
  return (
    //  : Main container for the section with background and centering.
