...
//  : This component displays a list of recommended projects, using the Cards component for each project.
export default function Recommended({ projects = [] }) {
  //  : If no projects are provided or the array is empty, show a message.
  ...
  return (
    //  : Main section for recommended projects.
    <section className="py-12 px-4 sm:px-6 lg:px-8">
