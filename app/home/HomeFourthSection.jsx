...
//  : This component displays testimonials and a section title/description for the fourth section of the home page.
const HomeFourthSection = ({ data }) => {
  return (
    //  : Main container for the section with background and padding.
