...
//  : This component displays a horizontally scrolling list of authorized partners' logos using a marquee effect.
const HomeFifthSection = ({ data }) => {
  //  : Ensure data is a valid array before mapping.
  const safeData = Array.isArray(data) ? data : [];

  return (
    //  : Main container for the section with padding and overflow handling.
